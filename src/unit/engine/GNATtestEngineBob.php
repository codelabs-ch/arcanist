...
/**
 * Unit test engine wrapper for GNATtest via Bob Build Tool.
 */
final class GNATtestEngineBob extends GNATtestEngine {
  ...
  public function run() {
    ...
    $bobRecipe = "muen_unittests";
    $bobAllTests = "muen::*-tests/*-test";
    ...
    $future = new ExecFuture
      ('%C', "bob -C $bobRoot query-path -f {build} $bobRecipe/$bobAllTests");
    ...
    echo "Running $bobRecipe...\n";
    $future = new ExecFuture('%C', "cd $bobRoot && bob dev $bobRecipe");
    $future->resolvex();
